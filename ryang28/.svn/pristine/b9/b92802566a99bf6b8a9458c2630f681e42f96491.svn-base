...
class Neural_Network():
    ...
    def forward(self, X):
        ...
        '''
        l1 = self.sigmoid(self.fully_connected(X, self.U, self.e))
        l2 = self.sigmoid(self.fully_connected(l1, self.W, self.f))
        return l2
...
def main():
    ...
    t = t/100 
    #a = np.array([[0.5, 0.0],[0.5,1.0],[1.0,1.0]])
    #t = np.array([[0.83],[0.16],[0.16]])
    #print(a.shape)
    #print(t.shape)
