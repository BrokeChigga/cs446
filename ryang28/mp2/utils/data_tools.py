...
def preprocess_data(dataset,
    ...
    x = []
    y = []
    for id_item in dataset:
        row = []
        row.append(int(dataset[id_item][columns_to_id['Id']]))
        row += one_hot_bldg_type(dataset[id_item][columns_to_id['BldgType']])
        row.append(int(dataset[id_item][columns_to_id['OverallQual']]))
        row.append(int(dataset[id_item][columns_to_id['GrLivArea']]))
        row.append(int(dataset[id_item][columns_to_id['GarageArea']]))
        x.append(row)
        y.append(int(dataset[id_item][columns_to_id['SalePrice']]))
